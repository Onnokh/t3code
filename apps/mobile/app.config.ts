    ...
    widgets: [
      {
        ...
        description: "Shows the current state of active PLOW Code agents.",
...
const config: ExpoConfig = {
  ...
  ios: {
    ...
    infoPlist: {
      ...
      NSLocalNetworkUsageDescription:
        "Allow PLOW Code to connect to PLOW Code servers on your local network or tailnet.",
  ...
  plugins: [
    ...
    [
      "expo-camera",
      {
        cameraPermission: "Allow PLOW Code to access your camera so you can scan pairing QR codes.",
