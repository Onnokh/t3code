...
const make = Effect.fn("desktop.environment.make")(function* (
  ...
  const baseDir = Option.getOrElse(configuredBaseDir, () => path.join(homeDirectory, ".plowcode"));
  ...
  const userDataDirName = isDevelopment ? "plowcode-dev" : "plowcode";
  const legacyUserDataDirName = isDevelopment ? "PLOW Code (Dev)" : "PLOW Code (Alpha)";
  ...
  return DesktopEnvironment.of({
    ...
    appUserModelId: Option.getOrElse(config.appUserModelIdOverride, () =>
      isDevelopment ? "com.plowtools.plowcode.dev" : "com.plowtools.plowcode",
    ),
    linuxDesktopEntryName: isDevelopment ? "plowcode-dev.desktop" : "plowcode.desktop",
    linuxWmClass: isDevelopment ? "plowcode-dev" : "plowcode",
    userDataDirName,
