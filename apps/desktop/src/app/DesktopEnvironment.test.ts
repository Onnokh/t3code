...
describe("DesktopEnvironment", () => {
  it.effect("derives state paths and development identity inside Effect", () =>
    Effect.gen(function* () {
      ...
      assert.equal(environment.appUserModelId, "com.plowtools.plowcode.dev");
      assert.equal(environment.linuxWmClass, "plowcode-dev");
      assert.deepEqual(
  ...
  it.effect("keeps implicit development state separate from production state", () =>
    Effect.gen(function* () {
      ...
      assert.equal(development.stateDir, "/Users/alice/.plowcode/dev");
      assert.equal(production.stateDir, "/Users/alice/.plowcode/userdata");
    }),
  );
