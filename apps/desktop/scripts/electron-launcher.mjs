...
const devBundleIdSuffix = NodePath.basename(repoRoot)
  .toLowerCase()
  .replaceAll(/[^a-z0-9]+/g, "");
export const APP_DISPLAY_NAME = isDevelopment ? "PLOW Code (Dev)" : "PLOW Code (Alpha)";
export const APP_BUNDLE_ID = isDevelopment
  ? `com.plowtools.plowcode.dev.${devBundleIdSuffix || "local"}`
  : "com.plowtools.plowcode";
const APP_PROTOCOL_SCHEMES = isDevelopment ? ["plowcode-dev"] : ["plowcode"];
