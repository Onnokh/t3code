...
export const ClientSettingsSchema = Schema.Struct({
  ...
  // Discord/Slack-style left-aligned chat with avatar + author + timestamp.
  chatLayoutV2Enabled: Schema.Boolean.pipe(Schema.withDecodingDefault(Effect.succeed(false))),
...
export const ClientSettingsPatch = Schema.Struct({
  ...
  chatLayoutV2Enabled: Schema.optionalKey(Schema.Boolean),
